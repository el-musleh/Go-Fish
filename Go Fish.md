...
# handle travel places
Just be normal, use google map to book mark them as want to go and write some info. I is normal and easy to check the map while traveling than creating note for each city and random order details that need process tome to take action. 
...
slehs-projects/~/integrations/supabase/icfg_QcP3NBB9mW0EIMIYgctn3Hfz/resources/storage/store_xezNVKbOsfqEROvN/guides


# Important
- [ ] Make the personas to plan the design for the next implementation on the project.

# TODOS
- [ ] Improve the process of creating events. 
	- auto-title and update for created new ticket.
- [ ] Fix the preferences - get the main advantage of idenfiy preferences running. 
	- is using preplexity API useful? 
- [ ] Fix calendar connection and identify free slots. 
- [ ] Fix the AI agent, group preferences event generation. 

Use AI gateway https://vercel.com/el-muslehs-projects/~/ai-gateway
https://vercel.com/el-mu

- [ ] Buy domain
- [ ] setup email service.
	- https://supabase.com/dashboard/project/moiajtcnyimeqllextxn/auth/templates
- [ ] Make beta release 0.2?!
...
# Go Fish mobile
- I really to show button to report a bug or suggestion as Tickets on github repo. 
- gamify it
- make delete state : collection inside the event ticket. Maximize to delete. Make view event a wide one at bottom. 


Hey! Let's do this! 🎉 Let's do a group activity with friends.

I just planned something awesome and I need YOU there! 💪

RSVP here 🔗 https://go-fish-nu.vercel.app/invite/78c11e06-4a03-4235-a75f-0dc3d57938b3
